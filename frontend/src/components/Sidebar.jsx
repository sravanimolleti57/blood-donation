...
const Sidebar = () => {
  ...
  const adminLinks = [
    ...
    { name: 'Hospital Verification', path: '/admin/hospitals', icon: FiCheckCircle },
    { name: 'All Requests', path: '/admin/requests', icon: FiDroplet },
  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 min-h-[calc(100vh-4rem)] flex flex-col justify-between p-4 shrink-0 shadow-xl border-r border-slate-800">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 p-3 bg-slate-800/80 rounded-xl border border-slate-700/60">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-[11px] font-medium text-brand-400 uppercase tracking-wider flex items-center gap-1">
